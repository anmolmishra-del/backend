...
class RestaurantAdmin(ModelView, model=Restaurant):
    ...
    column_list = [Restaurant.id, Restaurant.name, Restaurant.owner_id, Restaurant.cuisine_type, Restaurant.phone_number, Restaurant.email, Restaurant.status]
    form_columns = [Restaurant.name, Restaurant.owner_id, Restaurant.cuisine_type, Restaurant.phone_number, Restaurant.email, Restaurant.logo_url, Restaurant.banner_url, Restaurant.status, Restaurant.is_favorite]    
...
class MenuCategoryAdmin(ModelView, model=MenuCategory):
    ...
    column_list = [MenuCategory.id, MenuCategory.restaurant_id, MenuCategory.name]
    form_columns = [MenuCategory.restaurant_id, MenuCategory.name]
