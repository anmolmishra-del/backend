from sqlalchemy import BigInteger, Column, Float, Integer, String, Boolean, DateTime, false, func
...
class User(Base):
    ...
    username = Column(String(128), unique=False, index=False, nullable=False)
